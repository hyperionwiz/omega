...
class navigator:
    def root(self):
        api_keys.chk()
        self.addDirectoryItem('[COLORwhitesmoke]Contracts[/COLOR]', 'oneclick', 'oneclick.png', 'DefaultMovies.png')
    ...
    def movies(self, lite=False):
        self.addDirectoryItem(32639, 'movieMosts', 'watched.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem(32639, 'tvMosts', 'watched.png', 'DefaultTVShows.png')
        ...
        self.addDirectoryItem(32026, 'tvshows&url=premiere', 'upcoming.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        self.addDirectoryItem('[COLORwhitesmoke]Absolution : Changelog[/COLOR]', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem('[COLORwhitesmoke]Absolution : Cache Functions[/COLOR]', 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[COLORwhitesmoke]Absolution : Log Functions[/COLOR]', 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
