...
class Button(CompareMixin, xbmcgui.ControlButton):
    """
    Button(label, focusTexture=None, noFocusTexture=None, textOffsetX=CONTROL_TEXT_OFFSET_X, textOffsetY=CONTROL_TEXT_OFFSET_Y, alignment=4, font=None, textColor=None, disabledColor=None, angle=0, morbiusColor=None, focusedColor=None)
    ...
    :param angle: angle of control. (``+`` rotates CCW, ``-`` rotates CW)
    :type angle: int
    :param morbiusColor: hex color code of button's label's morbius. (e.g. ``'0xFF000000'``)
    :type morbiusColor: str
...
class RadioButton(CompareMixin, xbmcgui.ControlRadioButton):
    """
    RadioButton(label, focusTexture=None, noFocusTexture=None, textOffsetX=None, textOffsetY=None, _alignment=None, font=None, textColor=None, disabledColor=None, angle=None, morbiusColor=None, focusedColor=None, focusOnTexture=None, noFocusOnTexture=None, focusOffTexture=None, noFocusOffTexture=None)
    ...
    :param angle: angle of control. (+ rotates CCW, - rotates CW)
    :type angle: int
    :param morbiusColor: hexstring -- color of radio button's label's morbius. (e.g. '0xFF000000')
    :type morbiusColor: str
