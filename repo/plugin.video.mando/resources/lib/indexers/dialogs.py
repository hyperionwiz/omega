...
def options_menu_choice(params, meta=None):
	...
	single_ep_list = ('episode.progress', 'episode.recently_watched', 'episode.next_trakt', 'episode.next_mando', 'episode.next_simkl', 'episode.trakt_recently_aired', 'episode.trakt_calendar')
